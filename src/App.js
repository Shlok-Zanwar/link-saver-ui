...
import LinkSaver from "./AppComponents/LinkSaver";
import AllLinks from "./AppComponents/AllLinks";
				...
				*/}
				...
				>
                    ...
                    <Route path="links" element={<Outlet />} >
                        <Route path="edit/:id" element={<LinkSaver isEdit={true}/>} />
                        <Route path="add" element={<LinkSaver isEdit={false}/>} />
                        <Route path="" element={<AllLinks isEdit={false}/>} />
                    </Route>
